               ...
               <div className="row align-items-center justify-content-center">
                  <div className="col-lg-6 col-md-9">
                     <div className="about__images">
                        <img src={toAbsoluteUrl("/assets/img/others/about_img.png")} alt="img" className="main-img" />
                        <img src={toAbsoluteUrl("/assets/img/others/about_shape.svg")} alt="img" className="shape alltuchtopdown" />
                        ...
                        <div className="about__enrolled" data-aos="fade-right" data-aos-delay="200">
                           <p className="title"><span>250+</span> Enrolled Students</p>
                           <img src={toAbsoluteUrl("/assets/img/others/student_grp.png")} alt="img" />
                        </div>
                     </div>
                  </div>
                  ...
                  <div className="col-lg-6">
                     <div className="about__content">
                        <div className="section__title">
                           <span className="sub-title">India’s No. 1 Stock Market Course with Advanced Analytics</span>
                           <h2 className="title">
                              The Data Analytics Program: Your Path to Professional
                        ...
                        <p className="desc">Unlock the power of data to master trading! Our program empowers you with the analytical skills and strategies of a professional trader, designed for profitable outcomes. Explore diverse techniques across multiple financial markets, including Indian stocks, futures & options, forex, and commodities, with a focus on intraday and swing trading. Let data drive your success in the markets!</p>
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Beginner Friendly</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Very Affordable</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">One To One Doubt Session</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">QNA's</p>
                           </li>
                        </ul>
                        <div className="tg-button-wrap">
                           <Link to={toAbsoluteUrl("/shop-details")} className="btn arrow-btn">Enroll Now<BtnArrow /></Link>
                        </div>
                     </div>
                  </div>
               </div>
