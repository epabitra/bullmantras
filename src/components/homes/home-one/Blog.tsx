                  ...
                  <div key={item.id} className="col-xl-3 col-md-6">
                     <div className="blog__post-item shine__animate-item">
                        <div className="blog__post-thumb">
                           <Link to={toAbsoluteUrl("/blog-details")} className="shine__animate-link"><img src={item.thumb} alt="img" /></Link>
                           <Link to={toAbsoluteUrl("/blog")} className="post-tag">{item.tag}</Link>
                        </div>
                        <div className="blog__post-content">
                           <div className="blog__post-meta">
                              <ul className="list-wrap">
                                 <li><i className="flaticon-calendar"></i>{item.date}</li>
                                 <li><i className="flaticon-user-1"></i>by <Link to={toAbsoluteUrl("/blog-details")}>Admin</Link></li>
                              </ul>
                           </div>
                           <h4 className="title"><Link to={toAbsoluteUrl("/blog-details")}>{item.title}</Link></h4>
                        </div>
                     </div>
                  </div>
               ))}
