...
const InstructorTwo = ({ style }: InstructorTwoProps) => {
   ...
   const svgIconRef = SvgAnimation(toAbsoluteUrl('/assets/img/instructor/instructor_shape02.svg'));
   const svgIconRef2 = SvgAnimation(toAbsoluteUrl('/assets/img/instructor/instructor_shape02.svg'));
               ...
               <div className="row">
                  <div className="col-xl-6">
                     <div className="instructor__item-two tg-svg" ref={svgIconRef}>
                        <div className="instructor__thumb-two">
                           <img src={toAbsoluteUrl("/assets/img/instructor/instructor_two01.png")} alt="img" />
                           <div className="shape-one">
                              <InjectableSvg src={toAbsoluteUrl("/assets/img/instructor/instructor_shape01.svg")} alt="img" className="injectable" />
                           </div>
                  ...
                  <div className="col-xl-6">
                     <div className="instructor__item-two tg-svg" ref={svgIconRef2}>
                        <div className="instructor__thumb-two">
                           <img src={toAbsoluteUrl("/assets/img/instructor/instructor_two02.png")} alt="img" />
                           <div className="shape-one">
                              <InjectableSvg src={toAbsoluteUrl("/assets/img/instructor/instructor_shape01.svg")} alt="img" className="injectable" />
                           </div>
                           <div className="shape-two">
